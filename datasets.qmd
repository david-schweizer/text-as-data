...
-   [EUSpeech: A New Dataset of EU Elite Speeches (Version
    1.4)](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/GKABNU)

    -   **Description:** "This dataset presents EUSpeech (version 1.4),
        an updated dataset of 17,184 speeches from EU leaders (i.e.,
        heads of government in 10 member states, EU commissioners, party
        leaders in the European Parliament, and ECB and IMF leaders)
        from 2007 to 2015. Version 1.3 contained a number of duplicate
        speeches, because some websites contained the same speeches in
        English and in the original language. In version 1.4 only one
        version of these speeches is kept. (2019-3-29)"
